...
#define kMainPageDistance   kScreenWidth/3   //打开左侧窗时，主视图露出的宽度
#define kMainPageScale   0.8  //打开左侧窗时，主视图缩放比例
#define kMainPageCenter  CGPointMake(kScreenWidth + kScreenWidth * kMainPageScale / 2.0 - kMainPageDistance, kScreenHeight / 2)  //打开左侧窗时，主视图中心点
