...
@interface noteEdit ()<CJReMindTableVCDelegate>
{
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:247/255.0 green:251/255.0 blue:227/255.0 alpha:1];
    ...
    // items 初始化
    image = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"img"] style:UIBarButtonItemStyleDone target:self action:@selector(imageItem)];
    ...
    audio.tintColor = [UIColor orangeColor];
    ...
    write.tintColor = [UIColor orangeColor];
    ...
    remind.tintColor = [UIColor orangeColor];
...
-(void)setNoteTextView {
    // 高度：NavigationBar -- 64    toolBar -- 44
    noteTextView = [[UITextView alloc] initWithFrame:CGRectMake(20, 6, WIDTH-40, HEIGHT-50)];
    noteTextView.backgroundColor = [UIColor colorWithRed:248/255.0 green:250/255.0 blue:229/255.0 alpha:1];
    noteTextView.font = [UIFont fontWithName:@"Arial" size:18.0];
